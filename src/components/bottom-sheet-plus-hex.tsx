...
export const BottomSheetPlusHex = () => {
    ...
    const handleClickMeasurementButton = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center pt-8 px-10 gap-5">
            ...
            {/* TODO : 체력 측정 페이지로 연결 */}
            <button onClick={handleClickMeasurementButton} className={FONT_STYLES.heading4 + " text-white bg-black flex items-center justify-center w-full h-[80px] rounded-[30px]"}>6각 체력 측정하기</button>
            {/* TODO : 기능 추가 예정 */}
